/*
    ...
    Github: https://github.com/TheAlgorithms/Rust/blob/master/src/backtracking/sudoku.rs
*/
...
fn main() {
    ...
    if solved {
        sudoku.print_board(); // Print the solved board
    } else {
        println!("Sudoku cannot be solved.");
    }
