// https://github.com/TheAlgorithms/Rust/blob/6a1c2a63eef363024b0e38fb7d7b6b0509a21a3d/src/data_structures/binary_search_tree.rs
...
fn main() {
    ...
    list.insert_at_tail("hello");
    list.insert_at_tail("world");
    println!("Linked List is {}", list);

    println!("list.get(0): {:?}", list.get(0)); // -> Some("hello")
    println!("list.get(3): {:?}", list.get(3)); // -> None
